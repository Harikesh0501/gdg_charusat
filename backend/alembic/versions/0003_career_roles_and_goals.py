...
def upgrade() -> None:
    ...
    # Create skill_importance_enum via DO block
    ...
    op.create_table(
        ...
        sa.Column('importance', postgresql.ENUM('core', 'important', 'nice_to_have', name='skill_importance_enum', create_type=False), nullable=False),
...
def downgrade() -> None:
    ...
    op.execute(sa.text("DROP TYPE IF EXISTS skill_importance_enum;"))
